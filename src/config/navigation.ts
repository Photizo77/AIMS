...
export const NAV_ITEMS: NavItem[] = [
  ...
  { title: 'Grants', href: '/grants', icon: 'volunteer_activism', roles: ['CD', 'ED', 'SYS_ADMIN', 'COMPANY_ADMIN', 'GRANTS_MANAGER', 'GRANT_WRITER'] },
  ...
  { title: 'Approvals', href: '/approvals', icon: 'approval', roles: ['CD', 'ED'] },
  { title: 'Documents', href: '/documents', icon: 'folder', roles: 'ALL' },
  { title: 'Knowledge Base', href: '/knowledge', icon: 'menu_book', roles: 'ALL' },
  { title: 'CRM', href: '/crm', icon: 'contacts', roles: ['CD', 'ED', 'COMPANY_ADMIN'] },
...
export function getVisibleNavItems(userRole: Role): NavItem[] {
  return NAV_ITEMS.filter((item) => item.roles === 'ALL' || item.roles.includes(userRole));
}