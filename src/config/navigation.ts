...
const CD_NAV_ITEMS: NavItem[] = [
  ...
  { title: 'Approvals (Read-only)', href: '/approvals?view=readonly', icon: 'visibility', roles: ['CD'] },
  { title: 'Finance & Procurement', href: '/finance', icon: 'account_balance', roles: ['CD'] },
  { title: 'Attendance', href: '/attendance', icon: 'schedule', roles: ['CD'] },
  { title: 'HR & Admin Summary', href: '/hr', icon: 'people', roles: ['CD'] },
  { title: 'Innovations & Tasks', href: '/innovations', icon: 'lightbulb', roles: ['CD'] },
  { title: 'Documents', href: '/documents', icon: 'folder', roles: ['CD'] },
  { title: 'Inventory', href: '/inventory', icon: 'inventory_2', roles: ['CD'] },
