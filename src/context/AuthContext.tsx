...
const MOCK_USERS: Record<string, User> = {
  ...
  'grantsmanager@aims.org': { id: 'user-gm-001', name: 'Sarah Aciro', email: 'grantsmanager@aims.org', role: 'GRANTS_MANAGER', department: 'Grants', status: 'active', createdAt: '2025-04-20' },
  'grants@aims.org': { id: 'user-gw-001', name: 'Janet Apio', email: 'grants@aims.org', role: 'GRANT_WRITER', department: 'Grants', status: 'active', createdAt: '2025-05-05' },
